...
wrap.src = canvas.toDataURL("image/jpeg", 1.0);
wrap.style.display = "none";
wrap.setAttribute("id", "background");
...
function reflow(width, height) {
  var wAvailable = window.innerWidth - (300 + 16 + 16 + 16);
  var hAvailable = window.innerHeight - (16 + 16);
  if (width / height > wAvailable / hAvailable) {
    canvas.style.left = 300 + 16 + 16 + 'px';
    canvas.style.width = wAvailable + 'px';
    var hComputed = height / width * wAvailable;
    canvas.style.height = hComputed + 'px';
  } else {
    canvas.style.height = hAvailable + 'px';
    var wComputed = width / height * hAvailable;
    var wCenter = 300 + 16 + 16 + wAvailable * 0.5;
...
},{"./random":39,"./scene":40}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.generateNoiseTexture = generateNoiseTexture;
exports.createRenderer = createRenderer;
...
function createRenderer(regl) {
  var pgWidth = 256;
  var pgTexture = generateNoiseTexture(regl, null, pgWidth);
...
},{"gl-vec2":14}],4:[function(require,module,exports){
module.exports = add
...
},{"./add":4,"./clone":5,"./copy":6,"./create":7,"./cross":8,"./distance":9,"./divide":10,"./dot":11,"./forEach":12,"./fromValues":13,"./length":15,"./lerp":16,"./max":17,"./min":18,"./multiply":19,"./negate":20,"./normalize":21,"./random":22,"./scale":23,"./scaleAndAdd":24,"./set":25,"./squaredDistance":26,"./squaredLength":27,"./subtract":28,"./transformMat2":29,"./transformMat2d":30,"./transformMat3":31,"./transformMat4":32}],15:[function(require,module,exports){
...
},{"../":37}],36:[function(require,module,exports){
(function() {
...
},{"./lib/mersenne-twister":34,"./lib/park-miller":35,"./lib/xor":36}],38:[function(require,module,exports){
"use strict";
...
},{"rng":37}],40:[function(require,module,exports){
"use strict";
...
var _pointStars = require('./point-stars');

var pointStars = _interopRequireWildcard(_pointStars);
...
var nebula = _interopRequireWildcard(_nebula);

var _copy = require('./copy');

var copy = _interopRequireWildcard(_copy);
...
var Scene = function () {
  ...
  _createClass(Scene, [{
    ...
    value: function render(props) {
      ...
      var scale = props.shortScale ? Math.min(width, height) : Math.max(width, height);
...
},{"./copy":1,"./nebula":3,"./point-stars":38,"./random":39,"./star":41,"regl":33}],41:[function(require,module,exports){
"use strict";
